...
import type { Settings, Stop } from "@/types/trip"
...
const mapStyleOptions = {
  ...
  satellite: [], // Satellite is a mapTypeId, not a style array
}
...
export function TripMap({ mapStyle, stops, googleMapsApiKey }: TripMapProps) {
  ...
  return (
    <GoogleMap
      ...
      onUnmount={onUnmount}
      options={{
        styles: mapStyleOptions[mapStyle] || mapStyleOptions.default,
    ...
    >
      ...
      {directionsRequest && <DirectionsService options={directionsRequest} callback={directionsCallback} />}
