...
interface SettingsModalProps {
  ...
  tripName: string
  settings: Settings
  onUpdateSettings: (newSettings: Omit<Settings, "id" | "tripId">) => void
}

export function SettingsModal({ open, onOpenChange, tripName, settings, onUpdateSettings }: SettingsModalProps) {
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <RadioGroup value={mapStyle} onValueChange={(v) => setMapStyle(v as any)} className="flex gap-2">
          ...
          <div className="space-y-3">
            ...
            <RadioGroup value={distanceUnit} onValueChange={(v) => setDistanceUnit(v as any)} className="flex gap-4">
              <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch id="calculate-costs" checked={calculateCosts} onCheckedChange={setCalculateCosts} />
          </div>

          <div className="space-y-3">
            <Label className="text-sm font-medium">Currency</Label>
            <RadioGroup value={currency} onValueChange={(v) => setCurrency(v as any)} className="flex gap-4">
              <div className="flex items-center space-x-2">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Input id="fuel-cost" value={fuelCost} onChange={(e) => setFuelCost(e.target.value)} className="w-20" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <Input id="mpg" value={mpg} onChange={(e) => setMpg(e.target.value)} className="w-20" />
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch id="avoid-motorways" checked={avoidMotorways} onCheckedChange={setAvoidMotorways} />
          </div>
