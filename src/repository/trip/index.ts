 ...
 */
const getTripCollaborator = async (userId: string, tripId: string) => {
 ...
 */
async function updateTripWithDays(tripId: string, data: UpdateTripArg) {
 ...
 * @returns The updated trip
 */
async function updateTripDetails(userId: string, tripId: string, data: UpdateTripDetailsArg) {
